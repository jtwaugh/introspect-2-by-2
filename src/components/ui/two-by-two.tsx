    ...
    return (
        <div className="p-4">
            <div className='h-full flex justify-center'>
                <span className='title pb-4 text-center'>About your suffering, you said: <br/><br/><i>{props.description}</i><br/><br/> {"Let's break down what causes led to this phenomenon."} <br/> {"Notice how these may have very little to do with each other."}<br/>{"Notice how naively blaming yourself may avoid the (often tragic) complexity of the situation."} <br/><br/> {"Just write a few notes or keywords in each box and click Submit at the bottom when you're done"}.</span>
            </div>
